...
const Footer = () => {
    ...
    return (
        ...
        <footer className="bg-bg-img  dark:bg-gray-900">
            ...
            <div className="container text-neutral-50 t p-6 mx-auto">
                ...
                <div>
                    <p className="text-center text-gray-500 dark:text-gray-400">© Care Cord Pro 2024 - All rights reserved</p>
                </div>
            </div>
        </footer>
    );
